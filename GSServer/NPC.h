...
public:
	NPC(WORD id, WORD x, WORD y, const Color& color, ObjectType type, int hp) : HPObject{ id, x, y, color, type, hp } {}
	virtual ~NPC() {}
...
public:
	...
	HardcodedNPC(WORD id, WORD x, WORD y, int hp, Idle&& initState) : NPC{ id, x, y, GetColor(), Type, hp }, state{ std::forward<Idle>(initState) } {}
...
public:
	AI_NPC(WORD id, WORD x, WORD y, const Color& color, const char* scriptName, int hp) : NPC{ id, x, y, color, ObjectType::OBJECT, hp }, lua{ id, scriptName } {};
